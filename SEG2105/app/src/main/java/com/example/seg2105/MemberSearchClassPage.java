...
public class MemberSearchClassPage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_search_classname_member);
        ...
        search_button.setOnClickListener(new View.OnClickListener() { // goes to Search Class Name Page
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MemberSearchClassPage.this, SearchViewPage.class);
                ...
                MemberSearchClassPage.this.startActivity(intent);
            }
        });
    }
